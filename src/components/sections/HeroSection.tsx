  ...
  return (
    <div className='min-h-[calc(100vh-30px)] bg-center bg-no-repeat bg-cover flex items-center text-white relative' style={{backgroundImage: `url(${heroImage})`}}>
        <div className="container mx-auto px-5 max-w-2xl z-20">
            <div className="flex justify-center"><span className='bg-primary text-white px-3 py-2 mb-2'>Welcome To SJTS</span></div>
            <h1 className='text-5xl md:text-6xl serif text-center mb-3'>Your One-Stop Solution For All Your</h1>
